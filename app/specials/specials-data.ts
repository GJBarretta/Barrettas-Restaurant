...
export var pizzaSpecialData: Item[] = [
    new Item("Tuesday", "Sicilian Pizza", "$13.99"),
    new Item("Wednesday", "2 Medium Pizzas", "$15.99"),
    new Item("Thursday", "2 Large Pizzas", "$19.99"),
    new Item("Friday & Saturday", "3 Large Pizzas", "$29.99")
];
